...
/**
* auro-datepicker_calendar provides users a way to ... (it would be great if you fill this out)
 *
...
class AuroDatepicker_calendar extends LitElement {
  // constructor() {
  //   super();
  // }
...
if (!customElements.get("auro-datepicker_calendar")) {
  customElements.define("auro-datepicker_calendar", AuroDatepicker_calendar);
}
